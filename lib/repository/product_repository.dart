...
class ProductRepository {
 final InMemoryProductCache _cache;
  ...
  final StreamController<ProductRepositoryState> _controller = StreamController<ProductRepositoryState>.broadcast();
  ...
  Future<List<Product>> fetchProducts({bool forceRefresh = false}) async {
    ...
    _controller.add(ProductRepositoryState(
...
class FakeRemoteProductApi {
  ...
  Future<List<Product>> fetchProducts() async {
    ...
    return [
      Product(id: '1', name: 'Apple', price: 1.99, updatedAt: now),
      Product(id: '2', name: 'Banana', price: 0.99, updatedAt: now),
      Product(id: '3', name: 'Orange', price: 2.49, updatedAt: now),
    ];
  }
}
